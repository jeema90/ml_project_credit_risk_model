...
st.markdown("<h2>🏦 Lauki Finance: Credit Risk Modelling</h2>", unsafe_allow_html=True)
...
with row2[2]:
    avg_dpd_per_delinquency = st.number_input('⚠️ Avg DPD', min_value=0, value=20)
...
if st.button("🚀 Calculate Risk"):
    ...
    st.write(f"⚠️ **Default Probability:** {probability:.2%}")
