...
▶️ Average DPD per delinquency

▶️ Loan-to-income ratio

▶️ Number of open accounts
...
▶️ Information Value (IV) – measures predictive power of variables

▶️ Variance Inflation Factor (VIF) – removes multicollinearity

▶️ Domain Knowledge – ensures financial relevance
...
▶️ Gradient Boosting / XGBoost (if applicable)

▶️ Hyperparameter tuning was performed using:
